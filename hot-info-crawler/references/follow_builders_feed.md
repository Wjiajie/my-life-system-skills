...
本技能集成了 [Follow Builders](https://github.com/zarazhangrui/follow-builders) 项目的中央 Feed，作为 AI 行业动态的**预处理数据源**。该 Feed 由 GitHub Actions 每日自动通过官方 API 抓取，内容可靠、结构化，使用 `read_url_content` 即可秒级获取。
