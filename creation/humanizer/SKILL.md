---
name: humanizer
description: "Detect and rewrite AI-generated writing — 中文 (primary) and English (secondary). Use when 编辑/审校/润色/降AIGC/去AI味. 覆盖中文学术论文、公众号/小红书/知乎/微博文案、营销稿、产品文案、技术博客、报告、公文、商业邮件. Fixes 30+ 类中文 AI 痕迹(内容/语言语法/风格/伪人味/交流);支持 7 种风格切换、4 类改写策略、10 维度学术降重(120 条替换词表)."
---
...
1. **识别 AI 模式** — 扫描下面 30+ 类中文模式，尤其留意"伪人味/硬公众号腔"（必要时扫附录 A 的英文模式）
...
### 三点五、伪人味与硬公众号腔（Pseudo-human Voice · 4 类）

> 这类最容易漏：它们已经避开了「赋能 / 多维度」这类显性套话，但读起来还是 AI。原因是 AI 在模仿"有锋芒的人话"，结果用力过猛。

#### 34A. 生硬动词和硬拗比喻
**触发词：** 钻进 / 硬生生接到 / 砸进 / 塞进 / 掰开揉碎 / 一把拽回 / 先讲一个不绕的定义 / 说一个不绕弯的判断

**问题：** 动词太狠，和对象不贴。像是为了制造画面感临时拧上去的，不是作者自然说出来的。

**Before：**
> 我们先钻进企业现场，硬生生接到那些真实业务问题上，先讲一个不绕的定义。

**After：**
> 先把定义说清楚，再回到企业现场。很多问题不是模型问题，是业务流程本来就乱。

#### 34B. 「不是...而是...」反差句滥用
**触发：** 不是...而是... / 不是写在...而是写在... / 表面是...本质是... / 真正的问题不是...而是...

**问题：** 反差句可以有力，但 AI 会把每个判断都写成翻转金句。尤其是后半句塞进"历史恩怨、组织惯性、权力结构"这类大词时，很像装深刻。

**Before：**
> 权限规则不是写在文档里，而是写在"这个表不能给隔壁部门看"的历史恩怨里。

**After：**
> 权限规则当然有文档。但真正卡人的，往往是那些没人愿意明说的部门边界：这张表谁能看、谁不能看，过去吵过什么。

#### 34C. 绝对化口吻和重复否定
**触发词：** 没人填 / 没人用 / 没人看 / 全都 / 一定 / 从来 / 永远 / 根本没有 / 无一例外

**触发结构：** 没人 X，没人 Y / 业务方说要 A，实际痛点可能是 B、C、D

**问题：** 为了制造冲击力，把复杂现场说成绝对判断。真实写作者通常会留一点余地，或者给出观察范围。

**Before：**
> 业务方说要智能助手，实际痛点可能是审批卡住、字段没人填、系统没人用。

**After：**
> 业务方说要智能助手，但我会先看三件事：审批是不是卡在某个节点，字段是不是经常漏填，老系统是不是已经没人愿意打开。

#### 34D. 复杂罗列和风险清单堆叠
**触发：** A 只是第一步，后面还有 B、C、D、E、F、G / 从...到...再到... / 集成、评测、合规、上线、监控、培训、组织接受度

**问题：** 列表太满，像 AI 把所有相关名词一次性倒出来。真人会分层、删减，或者只抓最要命的两三个。

**Before：**
> 模型跑通只是第一步，后面还有集成、评测、合规、上线、监控、培训、组织接受度。

**After：**
> 模型跑通只是开始。真难的通常是三件事：接进现有系统，证明它稳定可用，再让业务团队愿意真的用起来。
...
3. **扫模式** — 30+ 中文模式 + 伪人味硬公众号腔 + 必要时的英文模式（附录 A）
